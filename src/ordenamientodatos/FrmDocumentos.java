...
public class FrmDocumentos extends javax.swing.JFrame {
    ...
    private void btnOrdenarRapidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOrdenarRapidoActionPerformed
        ...
        int indice = Documento.busquedaBinaria(clave, criterio);
        txtTiempo.setText(Util.getTextoTiempoCronometro());

        if (indice >= 0) {
            Documento docEncontrado = Documento.documentos.get(indice);
            JOptionPane.showMessageDialog(this, "Documento encontrado:\n" +
                    "Nombre: " + docEncontrado.getNombreCompleto() + "\n" +
                    "Documento: " + docEncontrado.getDocumento(), "Resultado de Búsqueda", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(this, "Documento no encontrado", "Resultado de Búsqueda", JOptionPane.ERROR_MESSAGE);
        }
